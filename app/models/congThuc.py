...
class Rules:
    ...
    def tong3goc(self):
        ...
        if v.get("A") and v.get("B") and not v.get("C"):
            ...
            v.them_Doi_Tuong(
                "C",
                "goc",
                {"gia_tri": v.get("C"), "cong_thuc": "Tổng 3 góc của tam giác"},
            )
            return True
        if v.get("A") and not v.get("B") and v.get("C"):
            ...
            v.them_Doi_Tuong(
                "B",
                "goc",
                {"gia_tri": v.get("B"), "cong_thuc": "Tổng 3 góc của tam giác"},
            )
            return True
    ...
    def chu_vi(self):
        ...
        if a and b and c and not v.get("P"):
            ...
            v.them_Doi_Tuong(
                "P", "chu_vi", {"gia_tri": P_value, "cong_thuc": "Công thức Chu Vi"}
            )
            return True
    ...
    def heron(self):
        ...
        if a and b and c and not v.get("S"):
            ...
            v.them_Doi_Tuong(
                "S", "dien_tich", {"gia_tri": S_value, "cong_thuc": "Công thức Heron"}
            )
            return True
    ...
    def dinh_ly_cos(self):
        ...
        if a and b and c and not A:
            ...
            v.them_Doi_Tuong(
                "A", "goc", {"gia_tri": A_value, "cong_thuc": "Định lý Cosin"}
            )
            return True
        if a and b and c and not B:
            ...
            v.them_Doi_Tuong(
                "B", "goc", {"gia_tri": B_value, "cong_thuc": "Định lý Cosin"}
            )
            return True
    ...
    def duong_trung_tuyen(self):
        ...
        if a and b and c and not v.get("m_a"):
            ...
            v.them_Doi_Tuong(
                "m_a",
                "duong_trung_tuyen",
                {"gia_tri": m_a_value, "cong_thuc": "Công thức Đường Trung Tuyến"},
            )
            return True
        if a and b and c and not v.get("m_b"):
            ...
            v.them_Doi_Tuong(
                "m_b",
                "duong_trung_tuyen",
                {"gia_tri": m_b_value, "cong_thuc": "Công thức Đường Trung Tuyến"},
            )
            return True
        if a and b and c and not v.get("m_c"):
            ...
            v.them_Doi_Tuong(
                "m_c",
                "duong_trung_tuyen",
                {"gia_tri": m_c_value, "cong_thuc": "Công thức Đường Trung Tuyến"},
            )
            return True
    ...
    def dien_tich_ngoai_tiep(self):
        ...
        if a and b and c and S and not R:
            ...
            v.set("R", R_val)
            v.them_Doi_Tuong(
                "R", "ban_kinh_ngoai", {"gia_tri": R_val, "cong_thuc": "S = abc/4R"}
            )
            return True
    ...
    def dien_tich_noi_tiep(self):
        ...
        if a and b and c:
            ...
            if not S and r:
                ...
                v.set("S", S_val)
                v.them_Doi_Tuong(
                    "S", "dien_tich", {"gia_tri": S_val, "cong_thuc": "S = p*r"}
                )
                return True
            if S and not r:
                r_val = S / p

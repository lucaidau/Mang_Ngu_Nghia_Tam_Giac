...
from tkinter import messageboxA
import traceback
...
# IMPORT MODEL
from controller import TriangleController
ctrl = TriangleController()
...
def solve():
    try:
        ...
        input_values = {key: entries[key].get().strip() for key in entries}
        
        # Gọi controller xử lý (Đây là điểm mấu chốt của MVC)
        dt = ctrl.execute_logic(input_values)

        # Sau đó giữ nguyên phần hiển thị kết quả bên dưới của bạn...
        result_box.delete(1.0, tk.END)
        # ... (code hiển thị của bạn)
